...
inline void face_detection(cv::Mat& image)
   ...
   // dynamically scale min object size by the width of the image (hueristically determined to be img_height / 4)  ((hueristically is a cool word for made up))
   int min_object_size = image.rows / 4;
